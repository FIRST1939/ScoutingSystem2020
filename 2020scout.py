...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb 19 09:2:18 2020

@author: caroline
"""
###  SCOUTING SYSTEM 2020  ###
...
#class for fouls, tech fouls, and auto balls picked up
class CounterClass:
    point = 0
...
#class for low goal makes and misses auto and tele
...
#class for auto and tele high goal misses, inner makes, outer makes
...
# get info from bosstop 

#get team
def getTeam():
    global teamno
    teamno = match_dbconn.getMatchInfo(match_no,position)
    title_str = "MATCH NO: %s TEAM NO: %s  Postion %s" %(match_no,teamno,position)
...
#Send main data, message box and dont use this data stuff                       
def sendMainData():
    global autoCycles
    global teleCycles
...
#connects shooter pos on screens
